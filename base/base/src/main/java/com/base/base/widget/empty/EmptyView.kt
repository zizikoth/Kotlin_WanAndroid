...
import com.base.base.databinding.LayoutEmptyViewBinding
...
class EmptyView @JvmOverloads constructor(
    ...
    init {
        binding = DataBindingUtil.inflate(LayoutInflater.from(context),R.layout.layout_empty_view,this,true)
    }
